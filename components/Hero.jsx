...
export default function Hero() {
  return (
    <div id="top" className={`stage ${styles.hero}`}>
      <img className={styles.heroBg} src="/images/hero-bg.webp" alt="" />

      <div className={styles.titleBlock}>
        <img src="/images/hero-title.webp" alt="#FRESH JUICES FROM ANOTHER PLANET" />
      </div>

      <div className={styles.bodyCta}>
        <img src="/images/hero-cta.webp" alt="" />
